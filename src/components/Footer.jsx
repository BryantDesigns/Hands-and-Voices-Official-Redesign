    ...
    <div>
      <div className="w-full h-fit bg-gradient-to-r from-hvblue to-white flex flex-row justify-evenly items-center py-4 border-t-8 border-hvorange">
        <h1 className="text-white text-2xl text-center font-bold">
          ...
          <span className="font-kaushan font-thin text-3xl text-hvorange">
            {" "}
            Mission?
          </span>
        </h1>
        ...
        <div className="px-4">
          ...
          <div className="flex flex-row w-full justify-start space-x-8 py-4 ml-8">
            ...
            >
              ...
              <img
                src={facebook}
                className="w-6 hover:grayscale-0 grayscale duration-300 hover:scale-125"
              />
            </a>
            <a
              href="https://www.instagram.com/handsandvoices/?hl=en"
              className="text-gray-400 hover:text-gray-500"
            >
            ...
            <a
              href="https://twitter.com/handsandvoices?lang=en"
              className="text-gray-400 hover:text-gray-500"
            >
              <span className="sr-only">Twitter</span>
              <img
                src={twitter}
                className="w-6 rounded-md hover:grayscale-0 grayscale duration-300 hover:scale-125"
              />
            </a>
          </div>
        </div>
